...
<div class="wrapper-info">
	<div class="col-left">
          ...
          <p><?php esc_attr_e('Laptop Repair is responsive template useful for computer, mobile phones, tablet, Mac, Windows, electronics, digital, software, desktop. online support, maintenance, services, consulting, training, help desk. SEO friendly, Multilingual friendly, RTL compatible, WooCommerce friendly, multipurpose, simple, flexible and easy to use.','laptop-repair'); ?></p>
	...
	<div class="col-right">			
			<div class="centerbold">
				<hr />
				<a href="<?php echo esc_url(LAPTOP_REPAIR_SKTTHEMES_LIVE_DEMO); ?>" target="_blank"><?php esc_attr_e('Live Demo', 'laptop-repair'); ?></a> | 
				<a href="<?php echo esc_url(LAPTOP_REPAIR_SKTTHEMES_PRO_THEME_URL); ?>"><?php esc_attr_e('Buy Pro', 'laptop-repair'); ?></a> | 
				<a href="<?php echo esc_url(LAPTOP_REPAIR_SKTTHEMES_THEME_DOC); ?>" target="_blank"><?php esc_attr_e('Documentation', 'laptop-repair'); ?></a>
