...
define('LAPTOP_REPAIR_SKTTHEMES_URL','https://www.sktthemes.net/','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.net/shop/laptop-repair-wordpress-theme/','laptop-repair');
define('LAPTOP_REPAIR_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.net/shop/free-computer-store-wordpress-theme','laptop-repair');
...
define('LAPTOP_REPAIR_SKTTHEMES_THEMES','https://www.sktthemes.net/themes/','laptop-repair');
/**
